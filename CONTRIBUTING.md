...
| **status-decision-mapping** | a status the vocabulary defines but the status→decision table omits — an artifact written with it would be rejected by its own validator |
